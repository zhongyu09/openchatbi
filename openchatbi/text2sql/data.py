...
from openchatbi.text2sql.text2sql_utils import _init_sql_example_retriever, _init_table_selection_example_dict
...
if _catalog_store:
    sql_example_retriever, sql_example_dicts = _init_sql_example_retriever(_catalog_store, config.get().vector_db_path)
